/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f74ae06e0d6b4b7fa516ba968af80230)
...
interface __BaseEnv_Env {
  ...
  LIVE_FEED_DO: DurableObjectNamespace<import('./worker/index').LiveFeedDO>;
  DFIR_MCP: DurableObjectNamespace<import('./worker/index').DfirMcpServer>;
  CRON_LOCK_DO: DurableObjectNamespace<import('./worker/index').CronLockDO>;
  REPORT_BUILDER: DurableObjectNamespace<import('./worker/index').ReportBuilderDO>;
  INVESTIGATOR_AGENT: DurableObjectNamespace<import('./worker/index').InvestigatorAgentDO>;
  RADAR_CRAWLER: DurableObjectNamespace<import('./worker/index').RadarCrawlerDO>;
  GLOBAL_PULSE_DO: DurableObjectNamespace<import('./worker/index').GlobalPulseDO>;
  SELF: Service<typeof import('./worker/index').default>;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ALLOW_DEV_ORIGINS' | 'SITE_URL' | 'OPEN_PUBLIC_READS'>
  > {}
}
