...
function missedCapabilityFor(tool: string): string {
  const map: Record<string, string> = {
    ...
    truecaller_lookup: 'Truecaller reverse phone lookup (name, carrier, spam)',
    intelx_search: 'IntelligenceX leaked-data search (emails, domains, BTC, IBANs)',
    intelx_phonebook: 'IntelligenceX phonebook (emails/domains by name/keyword)',
