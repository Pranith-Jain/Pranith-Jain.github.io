...
export async function secretLeaksHandler(c: Context<{ Bindings: Env }>): Promise<Response> {
  ...
  // If no leaks found, return sample data for demonstration
  if (leaks.length === 0) {
    const sampleLeaks: LeakEntry[] = [
      {
        id: 'aws-sample-1',
        provider: 'AWS Access Key',
        redactedKey: 'AKIA****3XYZ',
        repo: 'demo-repo',
        owner: 'example-user',
        ...
        exposureScore: 85,
        secretCount: 1,
        url: 'https://github.com/example/demo-repo/blob/main/config/aws.yaml',
      },
      {
        id: 'github-sample-1',
        provider: 'GitHub PAT',
        redactedKey: 'ghp_****8abc',
        repo: 'test-project',
        owner: 'dev-user',
        file: '.env.local',
        severity: 'critical',
        ...
        exposureScore: 90,
        secretCount: 1,
        url: 'https://github.com/dev-user/test-project/blob/main/.env.local',
      },
      {
        id: 'openai-sample-1',
        provider: 'OpenAI API Key',
        ...
        exposureScore: 70,
        secretCount: 1,
        url: 'https://github.com/research-lab/ml-pipeline/blob/main/config.py',
      },
      {
        id: 'stripe-sample-1',
        provider: 'Stripe Secret',
        redactedKey: 'sk_live_****4567',
        repo: 'ecommerce-app',
        owner: 'startup-inc',
        ...
        exposureScore: 88,
        secretCount: 1,
        url: 'https://github.com/startup-inc/ecommerce-app/blob/main/server/config.ts',
      },
      {
        id: 'slack-sample-1',
        provider: 'Slack Token',
        redactedKey: 'xoxb-****1234',
        repo: 'bot-scripts',
        owner: 'ops-team',
        file: 'slack-config.json',
        severity: 'high',
        source: 'file',
        timestamp: new Date().toISOString(),
        exposureScore: 65,
        secretCount: 1,
        url: 'https://github.com/ops-team/bot-scripts/blob/main/slack-config.json',
      },
      {
        id: 'google-sample-1',
        provider: 'Google API Key',
        redactedKey: 'AIza****5678',
        repo: 'mobile-app',
        owner: 'dev-studio',
        ...
        exposureScore: 72,
        secretCount: 1,
        url: 'https://github.com/dev-studio/mobile-app/blob/main/android/app/build.gradle',
      },
      {
        id: 'sendgrid-sample-1',
        provider: 'SendGrid Key',
        redactedKey: 'SG.****9abc',
        repo: 'email-service',
        owner: 'mailer-org',
        file: 'config/sendgrid.json',
        severity: 'critical',
        source: 'file',
        timestamp: new Date().toISOString(),
        exposureScore: 82,
        secretCount: 1,
        url: 'https://github.com/mailer-org/email-service/blob/main/config/sendgrid.json',
      },
      {
        id: 'gitlab-sample-1',
        provider: 'GitLab PAT',
        redactedKey: 'glpat-****mnop',
        repo: 'ci-pipeline',
        owner: 'devops-team',
        file: '.gitlab-ci.yml',
        severity: 'critical',
        ...
        exposureScore: 78,
        secretCount: 1,
        url: 'https://github.com/devops-team/ci-pipeline/blob/main/.gitlab-ci.yml',
      },
    ];

    response.leaks = sampleLeaks;
    response.total_secrets = sampleLeaks.length;
    response.total_repos = 6;
    response.total_providers = 6;
    response.severity_mix = { critical: 5, high: 3, medium: 0, low: 0 };
    response.leaderboard = {
      providers: [
        { name: 'AWS Access Key', count: 1, pct: 12.5 },
        { name: 'GitHub PAT', count: 1, pct: 12.5 },
        { name: 'OpenAI API Key', count: 1, pct: 12.5 },
        { name: 'Stripe Secret', count: 1, pct: 12.5 },
        { name: 'Slack Token', count: 1, pct: 12.5 },
        { name: 'Google API Key', count: 1, pct: 12.5 },
        { name: 'SendGrid Key', count: 1, pct: 12.5 },
        { name: 'GitLab PAT', count: 1, pct: 12.5 },
      ],
      repos: [
        { name: 'demo-repo', secrets: 1, owner: 'example-user' },
        { name: 'test-project', secrets: 1, owner: 'dev-user' },
        { name: 'ml-pipeline', secrets: 1, owner: 'research-lab' },
        { name: 'ecommerce-app', secrets: 1, owner: 'startup-inc' },
        { name: 'bot-scripts', secrets: 1, owner: 'ops-team' },
        { name: 'mobile-app', secrets: 1, owner: 'dev-studio' },
        { name: 'email-service', secrets: 1, owner: 'mailer-org' },
        { name: 'ci-pipeline', secrets: 1, owner: 'devops-team' },
      ],
      owners: [
        { name: 'example-user', repos: 1, totalSecrets: 1 },
        { name: 'dev-user', repos: 1, totalSecrets: 1 },
        { name: 'research-lab', repos: 1, totalSecrets: 1 },
        { name: 'startup-inc', repos: 1, totalSecrets: 1 },
        { name: 'ops-team', repos: 1, totalSecrets: 1 },
        { name: 'dev-studio', repos: 1, totalSecrets: 1 },
        { name: 'mailer-org', repos: 1, totalSecrets: 1 },
        { name: 'devops-team', repos: 1, totalSecrets: 1 },
      ],
    };
  }
