 ...
 * on load to hide dormant tools from nav + search until an operator
 * sets the matching `*_BRIDGE_URL` secret — a tool that can only return
 * a 503 setup hint shouldn't be advertised.
 *
