...
const PLATFORMS: PlatformCheck[] = [
  ...
  { id: 'linkedin-learning', name: 'LinkedIn Learning', category: 'tech', url: (u) => `https://www.linkedin.com/learning/${u}` },
  ...
  { id: 'stackexchange', name: 'Stack Exchange', category: 'other', url: (u) => `https://stackexchange.com/users/${u}` },
  ...
  { id: 'dba-se', name: 'Database Administrators', category: 'other', url: (u) => `https://dba.stackexchange.com/users/${u}` },
  { id: 'security-se', name: 'Information Security', category: 'other', url: (u) => `https://security.stackexchange.com/users/${u}` },
  { id: 'networkengineering-se', name: 'Network Engineering', category: 'other', url: (u) => `https://networkengineering.stackexchange.com/users/${u}` },
  { id: 'devops-se', name: 'DevOps', category: 'other', url: (u) => `https://devops.stackexchange.com/users/${u}` },
  { id: 'sre-se', name: 'Site Reliability Engineering', category: 'other', url: (u) => `https://sre.stackexchange.com/users/${u}` },
  { id: 'cloud-se', name: 'Cloud Computing', category: 'other', url: (u) => `https://cloudcomputing.stackexchange.com/users/${u}` },
  { id: 'crypto-se', name: 'Cryptography', category: 'other', url: (u) => `https://crypto.stackexchange.com/users/${u}` },
  { id: 'bitcoin-se', name: 'Bitcoin', category: 'other', url: (u) => `https://bitcoin.stackexchange.com/users/${u}` },
  { id: 'ethereum-se', name: 'Ethereum', category: 'other', url: (u) => `https://ethereum.stackexchange.com/users/${u}` },
  { id: 'iot-se', name: 'Internet of Things', category: 'other', url: (u) => `https://iot.stackexchange.com/users/${u}` },
  { id: 'retrocomputing', name: 'Retrocomputing', category: 'other', url: (u) => `https://retrocomputing.stackexchange.com/users/${u}` },
  ...
  { id: 'gamedev-se', name: 'Game Development', category: 'other', url: (u) => `https://gamedev.stackexchange.com/users/${u}` },
  { id: 'ux-se', name: 'User Experience', category: 'other', url: (u) => `https://ux.stackexchange.com/users/${u}` },
  { id: 'graphicdesign-se', name: 'Graphic Design', category: 'other', url: (u) => `https://graphicdesign.stackexchange.com/users/${u}` },
  ...
  { id: 'gardening-se', name: 'Gardening', category: 'other', url: (u) => `https://gardening.stackexchange.com/users/${u}` },
  { id: 'diy-se', name: 'Home Improvement', category: 'other', url: (u) => `https://diy.stackexchange.com/users/${u}` },
  { id: 'money-se', name: 'Personal Finance', category: 'other', url: (u) => `https://money.stackexchange.com/users/${u}` },
  { id: 'law-se', name: 'Law', category: 'other', url: (u) => `https://law.stackexchange.com/users/${u}` },
  { id: 'philosophy-se', name: 'Philosophy', category: 'other', url: (u) => `https://philosophy.stackexchange.com/users/${u}` },
  { id: 'history-se', name: 'History', category: 'other', url: (u) => `https://history.stackexchange.com/users/${u}` },
  { id: 'buddhism-se', name: 'Buddhism', category: 'other', url: (u) => `https://buddhism.stackexchange.com/users/${u}` },
  { id: 'judaism-se', name: 'Judaism', category: 'other', url: (u) => `https://judaism.stackexchange.com/users/${u}` },
  { id: 'christianity-se', name: 'Christianity', category: 'other', url: (u) => `https://christianity.stackexchange.com/users/${u}` },
  { id: 'islam-se', name: 'Islam', category: 'other', url: (u) => `https://islam.stackexchange.com/users/${u}` },
  { id: 'hinduism-se', name: 'Hinduism', category: 'other', url: (u) => `https://hinduism.stackexchange.com/users/${u}` },
  { id: 'skeptics-se', name: 'Skeptics', category: 'other', url: (u) => `https://skeptics.stackexchange.com/users/${u}` },
  { id: 'puzzling-se', name: 'Puzzling', category: 'other', url: (u) => `https://puzzling.stackexchange.com/users/${u}` },
  { id: 'rpg-se', name: 'Role-playing Games', category: 'other', url: (u) => `https://rpg.stackexchange.com/users/${u}` },
  { id: 'boardgames-se', name: 'Board & Card Games', category: 'other', url: (u) => `https://boardgames.stackexchange.com/users/${u}` },
  ...
  { id: 'fitness-se', name: 'Physical Fitness', category: 'other', url: (u) => `https://fitness.stackexchange.com/users/${u}` },
  { id: 'travel-se', name: 'Travel', category: 'other', url: (u) => `https://travel.stackexchange.com/users/${u}` },
  { id: 'expatriates-se', name: 'Expatriates', category: 'other', url: (u) => `https://expatriates.stackexchange.com/users/${u}` },
  { id: 'parenting-se', name: 'Parenting', category: 'other', url: (u) => `https://parenting.stackexchange.com/users/${u}` },
  { id: 'workplace-se', name: 'The Workplace', category: 'other', url: (u) => `https://workplace.stackexchange.com/users/${u}` },
  { id: 'freelancing-se', name: 'Freelancing', category: 'other', url: (u) => `https://freelancing.stackexchange.com/users/${u}` },
  { id: 'expressionengine-se', name: 'ExpressionEngine', category: 'other', url: (u) => `https://expressionengine.stackexchange.com/users/${u}` },
  { id: 'drupal-se', name: 'Drupal', category: 'other', url: (u) => `https://drupal.stackexchange.com/users/${u}` },
  { id: 'wordpress-se', name: 'WordPress Development', category: 'other', url: (u) => `https://wordpress.stackexchange.com/users/${u}` },
  { id: 'magento-se', name: 'Magento', category: 'other', url: (u) => `https://magento.stackexchange.com/users/${u}` },
  { id: 'salesforce-se', name: 'Salesforce', category: 'other', url: (u) => `https://salesforce.stackexchange.com/users/${u}` },
  { id: 'sharepoint-se', name: 'SharePoint', category: 'other', url: (u) => `https://sharepoint.stackexchange.com/users/${u}` },
  { id: 'power-platform-se', name: 'Power Platform', category: 'other', url: (u) => `https://powerplatform.stackexchange.com/users/${u}` },
  { id: 'dynamics-se', name: 'Dynamics 365', category: 'other', url: (u) => `https://dynamicscrmfocal.stackexchange.com/users/${u}` },
  { id: 'outlook-se', name: 'Outlook', category: 'other', url: (u) => `https://outlook.office365.com/owa/?realm=${u}` },
  { id: 'teams-se', name: 'Microsoft Teams', category: 'other', url: (u) => `https://teams.microsoft.com/l/chat/0/0?users=${u}` },
  ...
  { id: 'gcp-se', name: 'Google Cloud', category: 'other', url: (u) => `https://console.cloud.google.com/home/dashboard?project=${u}` },
