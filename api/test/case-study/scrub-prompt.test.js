...
describe('scrubString', () => {
    ...
    it('does not over-strip — the words ignore/system in normal sentences survive', () => {
        expect(scrubString("Don't ignore the system logs when investigating this CVE.")).toBe("Don't ignore the system logs when investigating this CVE.");
