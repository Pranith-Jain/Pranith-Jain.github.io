...
describe('postProcess', () => {
    it('keeps hook preamble and validates required sections', () => {
        const raw = `A perfect 10. That's what CVSS gave CVE-2026-20182.\n\n` +
    ...
    it('extracts IOCs from the body', () => {
        ...
        const out = postProcess({
            type: 'cve',
            raw,
            factsText: '1.2.3.4 abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890 badc2.example.com CVE-2026-1234',
        });
        expect(out.ok).toBe(true);
    ...
    it('does not extract victim or source domains as IOCs (ransom)', () => {
        const raw = `Inc Ransom added 5 victims this week.\n\n` +
