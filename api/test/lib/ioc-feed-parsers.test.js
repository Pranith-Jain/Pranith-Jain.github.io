...
import { parseUrlhaus, parseMalwarebazaar, parseThreatfox, parseOpenPhish, parseCisaKev, parseSslblC2, parseBotvrijDomains, buildSummary, } from '../../src/lib/ioc-feed-parsers';
// ─── URLhaus ────────────────────────────────────────────────────────────────
...
describe('parseUrlhaus', () => {
    ...
    it('caps at 100 entries', () => {
        const rows = Array.from({ length: 150 }, (_, i) => `"${i}","2026-05-08 00:00:00","http://url${i}.example.com/","online","","malware","","","reporter"`).join('\n');
