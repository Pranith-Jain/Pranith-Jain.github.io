...
import {
  filterByTopic,
  tokenizeQuery,
  BREACH_COVERAGE_SOURCES,
  type CoverageInputItem,
} from '../../src/lib/breach-coverage';
...
function item(partial: Partial<CoverageInputItem> & { title: string; link: string }): CoverageInputItem {
  return {
    source_id: 'src',
    source_name: 'Source',
