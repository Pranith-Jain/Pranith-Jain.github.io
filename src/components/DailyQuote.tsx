...
export function DailyQuote() {
  ...
  return (
    <section aria-label="Quote of the day" className="py-3 sm:py-5">
      <figure className="glass relative overflow-hidden px-6 py-7 sm:px-10 sm:py-9 group transition-colors duration-300 hover:border-brand-500/30">
        ...
        <div
          ...
          style={{
            background: 'radial-gradient(closest-side, rgba(67, 94, 241, 0.22), transparent 70%)',
          }}
        />
        ...
        <div className="relative flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2 text-micro uppercase tracking-[0.2em] text-brand-600 dark:text-brand-400 mb-2">
              ...
              <span className="text-slate-500 dark:text-slate-400">{quote.topic}</span>
            </div>
