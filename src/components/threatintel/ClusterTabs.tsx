...
export const RANSOMWARE_TABS: ClusterTab[] = [
  ...
  { label: 'Activity', to: '/threatintel/ransomware-hub' },
  { label: 'Map', to: '/threatintel/ransomware-hub' },
  { label: 'Report', to: '/threatintel/ransomware-hub' },
  { label: 'Negotiations', to: '/threatintel/ransomware-hub?tab=negotiations' },
  { label: 'Wallets', to: '/threatintel/ransomware-hub' },
