/**
 * ISO-3166-1 alpha-2 → { lat, lng } centroid table.
 * Covers ~250 entries; unknown codes are handled gracefully by callers.
 */
...
export const COUNTRY_CENTROIDS: Record<string, { lat: number; lng: number }> = {
  ...
  PM: { lat: 46.94, lng: -56.27 },
  PN: { lat: -24.38, lng: -128.32 },
...
/**
 * Look up a centroid by ISO-3166-1 alpha-2 code.
 * Returns null for unknown codes (callers should log and skip).
 */
export function getCentroid(code: string): { lat: number; lng: number } | null {
