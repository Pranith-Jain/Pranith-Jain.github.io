...
import { Brain, RefreshCw, X, Shield, TrendingUp, TrendingDown, Minus, Eye, Check, Link2 } from 'lucide-react';
...
function CountryShareRow({ intel, country }: { intel: CountryIntel; country: string }) {
  ...
  return (
    <div className="flex items-center gap-2 pt-3 border-t border-brand-500/10">
