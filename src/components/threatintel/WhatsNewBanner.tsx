  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2">
        <span className="inline-flex items-center gap-1.5 text-xs font-mono uppercase tracking-wider text-rose-700 dark:text-rose-300 shrink-0">
        ...
        <ul className="flex flex-wrap items-center gap-1.5">
          {rows.map((r) => (
            <li key={r.key}>
              <Link
                to={r.to}
                className="inline-flex items-baseline gap-1 px-2 py-1 rounded border border-rose-500/40 bg-rose-500/15 dark:bg-rose-500/15 text-xs font-mono text-rose-800 dark:text-rose-200 hover:border-rose-400 hover:bg-rose-500/25 dark:hover:bg-rose-500/25"
                onClick={() => {
        ...
        <div className="ml-auto flex items-center gap-1 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1 text-mini font-mono text-rose-700 dark:text-rose-300 hover:text-rose-800 dark:hover:text-rose-100 px-2 py-1 rounded hover:bg-rose-500/15 dark:hover:bg-rose-500/15"
          ...
          <button
            ...
            aria-label="Dismiss"
            className="inline-flex items-center justify-center min-h-[44px] min-w-[44px] sm:min-h-[28px] sm:min-w-[28px] rounded text-rose-700 dark:text-rose-300 hover:text-rose-800 dark:hover:text-rose-100 hover:bg-rose-500/15 dark:hover:bg-rose-500/15"
          >
            <X size={12} />
          </button>
        </div>
