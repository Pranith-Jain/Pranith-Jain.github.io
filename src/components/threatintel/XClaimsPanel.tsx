...
export function XClaimsPanel() {
    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 text-xs font-mono px-2.5 py-1 rounded-md border transition-colors ${
        tab === id
          ...
          : 'border-slate-300/60 dark:border-slate-700 text-slate-600 dark:text-slate-400 hover:border-slate-400'
      }`}
    >
  ...
  return (
    <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/60 dark:bg-slate-900/40 p-5 mb-6 animate-fade-in-up">
