                        ...
                        >
                          <Icon
                            ...
                            className={`flex-shrink-0 ${
                              active
                                ? activeIcon
                                : 'text-muted group-hover:text-slate-600 dark:group-hover:text-slate-300'
                            }`}
                            aria-hidden="true"
                          />
                          ...
                          {item.badge && (
                            <span
                              className={`shrink-0 rounded px-1 py-px text-micro font-mono font-bold uppercase leading-none ${
                                item.badge === 'live'
