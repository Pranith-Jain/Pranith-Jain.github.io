...
export function BottomNav({ mode, onOpenSearch }: BottomNavProps): JSX.Element {
  ...
  return (
    <nav
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-slate-200 bg-white/95 backdrop-blur-md dark:border-[#1e2030] dark:bg-[#0a0a0f]/95 safe-area-pb"
