    ...
    <section className="scroll-mt-24">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="flex h-full flex-col gap-3 rounded-lg border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200)/0.4)] p-5"
          >
        ...
        {entries.map((e) => {
          ...
          return (
            <li key={e.href}>
              <Link
                to={e.href}
                className="group card-hover flex h-full flex-col gap-3 rounded-lg border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200)/0.4)] p-5 transition"
              >
