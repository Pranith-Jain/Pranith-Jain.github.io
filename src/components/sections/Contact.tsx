...
export function Contact({ personalInfo }: ContactProps) {
  return (
    <section id="contact" className="scroll-mt-24" aria-labelledby="contact-heading">
      ...
      <div className="relative overflow-hidden rounded-lg border border-black/10 bg-white px-5 py-10 dark:border-white/10 dark:bg-[rgb(18,18,24)] sm:px-10 sm:py-14 lg:py-16">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-2.5">
            <a
              ...
              className="inline-flex h-12 items-center gap-1.5 rounded-md bg-slate-900 px-5 text-base font-medium text-white transition-colors hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 focus-visible:outline-none"
