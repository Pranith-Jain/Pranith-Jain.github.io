    ...
    <section className="relative pt-4 lg:pt-6">
      <div className="grid lg:grid-cols-[1fr_auto] gap-10 lg:gap-16 items-start animate-fade-in-up">
        ...
        <div className="shrink-0 lg:sticky lg:top-24">
          <div className="rounded-lg border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-[rgb(18,18,24)] sm:p-7 flex flex-col items-center sm:items-start text-center sm:text-left">
