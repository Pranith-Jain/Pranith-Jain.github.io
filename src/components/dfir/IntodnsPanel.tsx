...
export function IntodnsPanel({ domain, title = 'IntoDNS.ai grade' }: IntodnsPanelProps): JSX.Element {
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-mini font-mono text-slate-500 dark:border-slate-800 dark:bg-slate-900/40 dark:text-slate-400">
    ...
    >
      <header className="flex flex-wrap items-center gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex shrink-0 items-center gap-1 rounded-md border border-slate-200 px-2.5 py-1 text-mini font-mono text-slate-700 hover:border-slate-300 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:border-slate-600 dark:hover:bg-slate-800/50"
        >
