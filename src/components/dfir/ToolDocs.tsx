      ...
      if (t.path === path) {
        ...
        return (
          <section
            ...
            className="mb-6 rounded-xl border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200)/0.4)] shadow-e1 p-4"
          >
            <div className="grid gap-3 sm:grid-cols-3 text-tool">
              {t.useCase && (
                <div>
                  ...
                  <p className="text-body leading-snug">{t.useCase}</p>
                </div>
              )}
              {t.cantDo && (
                <div>
                  ...
                  <p className="text-body leading-snug">{t.cantDo}</p>
                </div>
              )}
              {t.workflow && (
                <div>
                  ...
                  <p className="text-body leading-snug">{t.workflow}</p>
                </div>
              )}
            </div>
          </section>
