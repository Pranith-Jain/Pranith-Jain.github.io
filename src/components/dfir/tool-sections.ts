...
export const SECTIONS: Section[] = [
  ...
  },
  {
    id: 'forensics',
    group: 'dfir',
    label: 'Forensics & File Analysis',
    blurb: 'Artifact parsers, file analysers, and evidence decoders.',
    tools: [
      {
        path: '/dfir/decode',
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        desc: 'Describe a detection in plain English → generates rules in 10 formats: Sigma, KQL, Splunk SPL, Elastic EQL, YARA, Snort, Suricata, DLP regex, Semgrep, Falco · powered by Workers AI / Groq · edit + export',
        icon: Sparkles,
      },
      {
        path: '/dfir/taxii',
        ...
        desc: 'In-browser TAXII 2.1 server · serves STIX 2.1 collections from localStorage · discovery, collections, and objects endpoints · compatible with OpenCTI, MISP, and any TAXII client',
        icon: Share2,
      },
      {
        path: '/dfir/lolbins',
      ...
      },
      {
        ...
        desc: 'Graph database for threat intel · BFS shortest path · community detection · relationship mapping · visualize how IOCs connect to actors, malware, and campaigns',
        icon: GitBranch,
      },
      {
        ...
        desc: 'Reconstruct attack progression from IOCs · maps to 14 MITRE tactics · predicts next move · identifies gaps · generates detection recommendations',
        icon: Target,
      },
      {
        path: '/dfir/hunting-query-generator',
        useCase: 'Generate hunting queries for 7 SIEM platforms from a threat description.',
        label: 'Hunting Query Generator',
        desc: 'Describe a threat → generates detection queries for Splunk, KQL, Sigma, Elastic, YARA, Snort, Suricata · MITRE-mapped · recommended actions',
        icon: Crosshair,
      },
      {
        path: '/dfir/sandbox',
        ...
        desc: 'Hash lookup across VirusTotal, MalwareBazaar, ANY.RUN, Triage, Hybrid Analysis, Joe Sandbox · consensus verdict · behavioral analysis · family attribution',
        icon: Upload,
      },
      {
