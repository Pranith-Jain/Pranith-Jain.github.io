...
export const SECTIONS: Section[] = [
  // ── DFIR / Forensics group ───────────────────────────────────────
  {
    ...
    tools: [
      ...
      {
        path: '/dfir/x-verdikt',
        useCase: 'Cross-reference an IOC across 10 threat-intel sources for consensus verdict.',
        label: 'X-VERDIKT Multi-Source Verdict',
        desc: 'VT · AbuseIPDB · OTX · URLScan · ThreatFox · URLhaus · MalwareBazaar · HybridAnalysis · FileScan.io · Shodan · parallel engine · consensus scoring',
        icon: Shield,
      },
    ],
  },
  ...
  },
  {
    ...
    tools: [
      ...
      {
        path: '/dfir/regscope',
        useCase: 'Analyze a Windows registry key for known malware persistence patterns.',
        label: 'REGSCOPE Registry Analyzer',
        desc: 'Paste registry key path → known-key matching · 25+ entries · persistence, defense evasion, credential access · ATT&CK mapped · 100% client-side',
        icon: FolderTree,
      },
    ],
  },
  ...
  },
  {
    ...
    tools: [
      ...
      {
        path: '/dfir/attmap-ai',
        useCase: 'Map adversary behavior to MITRE ATT&CK techniques with confidence scores.',
        label: 'ATTMAP-AI ATT&CK Mapper',
        desc: 'Paste report/alert/log/behavior → AI maps to ATT&CK techniques · confidence scoring · tactic grouping · evidence extraction',
        icon: Target,
      },
    ],
  },
