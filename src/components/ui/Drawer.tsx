      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between gap-3 sm:gap-4 border-b border-slate-200 bg-white/95 px-4 sm:px-6 py-3 sm:py-4 backdrop-blur dark:border-[rgb(var(--border-400))] dark:bg-[rgb(var(--surface-200)/0.95)]">
          ...
          <button
            type="button"
            onClick={onClose}
            className="shrink-0 grid h-11 w-11 sm:h-9 sm:w-9 place-items-center rounded text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 dark:hover:bg-[rgb(var(--surface-300))] dark:hover:text-slate-300"
