    ...
    <div className={className}>
      ...
      <div className="relative">
        <select
          ...
          className={`w-full appearance-none rounded border px-3 py-2 pr-9 text-sm font-mono transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/20 disabled:opacity-50 disabled:cursor-not-allowed ${
            error
