...
const VARIANT_STYLES = {
  ...
  button:
    'px-3 py-1.5 rounded text-tool font-medium bg-slate-100 dark:bg-[rgb(var(--surface-300))] text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-[rgb(var(--surface-300))]',
