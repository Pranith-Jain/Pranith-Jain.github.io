      ...
      {actions.map((a, i) => {
        ...
        return (
          <Link
            ...
            className={`qa-tile group relative flex items-start gap-3 rounded-xl border border-slate-200 dark:border-[#1e2030] bg-white dark:bg-[#12121a] shadow-e1 p-3.5 transition-all duration-150 motion-safe:hover:-translate-y-0.5 hover:bg-slate-50 dark:hover:bg-[#16161f] focus:outline-none focus-visible:ring-2 ${accent.border} ${accent.shadow} ${accent.ring}`}
          >
            <span
