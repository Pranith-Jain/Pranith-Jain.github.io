  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        desc: 'Curated list of exploitable CVEs with PoC/exploit availability, EPSS, and KEV status.',
      ...
      },
      {
        ...
        desc: 'Kubernetes and container-specific CVEs — kubelet, API server, etcd, and CNI vulnerabilities.',
        compVar: 'K8sCves',
      },
      {
        ...
        tabId: 'list',
        label: 'CVE List',
        desc: 'Full CVE list with search, filter, and export capabilities.',
        compVar: 'CveList',
      },
    ],
  },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        tabId: 'agent-mesh',
        label: 'Agent Mesh',
        desc: 'Live multi-agent orchestration — specialist transitions, tool calls, step timeline.',
        compVar: 'AgentMesh',
        badge: 'new',
      },
      {
      ...
      },
      {
        ...
        label: 'Knowledge Graph',
        desc: 'Interactive knowledge graph of entities — actors, malware, campaigns, IOCs, and their relationships.',
        compVar: 'KnowledgeGraphPage',
      },
    ],
  },
  {
