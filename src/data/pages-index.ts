...
const THREATINTEL_PAGES: readonly PageEntry[] = [
  ...
  },
  {
    ...
    description:
      'Alias for the Tools hub MCP search. Live gateway to TI Mindmap HUB — search reports, CVEs, IOCs, knowledge graph, briefings, and STIX bundles in parallel.',
    sectionLabel: 'Threat Intel · Tools',
    group: 'threatintel',
    keywords: ['mindmap', 'mind map', 'ti-mindmap', 'ti mindmap hub', 'mcp', 'model context protocol', 'tool search'],
  },
  {
