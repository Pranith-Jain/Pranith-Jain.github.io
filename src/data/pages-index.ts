...
const DFIR_PAGES: readonly PageEntry[] = [
  ...
  },
  {
    ...
    description: 'Legitimate domains attackers abuse for phishing, C2, exfiltration, and downloads (LOTS Project).',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['lots', 'trusted sites', 'c2', 'phishing domains'],
  },
  {
    path: '/dfir/malapi',
    label: 'MalAPI',
    description: 'Windows APIs abused by attackers - mapped to attack categories with library and MS docs links.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['winapi', 'malapi', 'windows api', 'imports'],
  },
  {
    path: '/dfir/car',
    label: 'MITRE CAR',
    description: 'Cyber Analytics Repository - validated detection analytics mapped to ATT&CK techniques.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['car', 'cyber analytics repository', 'detections'],
  },
  {
    path: '/dfir/capec',
    label: 'MITRE CAPEC',
    description: 'Attack patterns - how adversaries exploit weaknesses, with CWE and ATT&CK cross-references.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
  ...
  },
  {
    ...
    label: 'HijackLibs',
    description: 'DLL hijacking candidates - DLLs abusable for sideloading with known vulnerable executables.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['hijacklibs', 'dll sideloading', 'dll hijacking', 't1574'],
  },
  {
    path: '/dfir/veris',
    label: 'VERIS Taxonomy',
    description: 'Incident taxonomy - standard Actor/Action/Asset/Attribute vocabulary for coding incidents.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['veris', 'taxonomy', 'incident classification', '4a'],
  },
  {
    path: '/dfir/engage',
    label: 'MITRE Engage',
    description: 'Adversary engagement - deception and denial approaches across Prepare/Engage/Understand.',
    sectionLabel: 'DFIR · Triage',
    group: 'dfir',
    keywords: ['engage', 'deception', 'honeypot', 'adversary engagement'],
  },
  {
  ...
  },
  {
    ...
    label: 'Agent Suite',
    description: 'AI agent investigation - tool-call analysis, observable enrichment, and attack-surface mapping.',
    sectionLabel: 'DFIR · AI Security',
    group: 'dfir',
  ...
  },
  {
    path: '/dfir/iam-hub',
    label: 'IAM & RBAC Hub',
    description: 'Cloud identity analysis - AWS, GCP, Azure, and Kubernetes RBAC policy analyzers.',
    sectionLabel: 'DFIR · Cloud',
    group: 'dfir',
  ...
  },
  {
    ...
    description: 'Phone number OSINT - carrier lookup, line type, breach presence, and AI-powered risk scoring.',
    sectionLabel: 'DFIR · OSINT',
    group: 'dfir',
  ...
  },
  {
    path: '/dfir/codec',
    label: 'Codec Hub',
    description: 'Decode and encode across base64, hex, URL, rot13, zlib, gzip with auto-detection.',
...
const THREATINTEL_PAGES: readonly PageEntry[] = [
  ...
  },
  {
    ...
    label: 'Dashboard Hub',
    description: 'Threat intelligence dashboards - TI weekly report, CTI operations, and live threat landscape.',
    sectionLabel: 'Threat Intel · Dashboards',
    group: 'threatintel',
  ...
  {
    path: '/threatintel/f2t2ea',
    label: 'F2T2EA (alias)',
    description: 'Alias for the Knowledge Base F2T2EA tab.',
    sectionLabel: 'Threat Intel · Reference',
    group: 'threatintel',
  },
  {
    path: '/threatintel/ooda',
    label: 'OODA Loop (alias)',
    description: 'Alias for the Knowledge Base OODA tab.',
    sectionLabel: 'Threat Intel · Reference',
    group: 'threatintel',
  },
  {
    path: '/threatintel/kill-chain-v2',
    label: 'Cyber Kill Chain v2 (alias)',
    description: 'Alias for the Knowledge Base Kill Chain v2 tab.',
    sectionLabel: 'Threat Intel · Reference',
    group: 'threatintel',
  },
  {
    path: '/threatintel/unified-kill-chain',
    label: 'Unified Kill Chain (alias)',
    description: 'Alias for the Knowledge Base Unified Kill Chain tab.',
    sectionLabel: 'Threat Intel · Reference',
    group: 'threatintel',
  },
  {
  ...
  },
  {
    ...
    group: 'threatintel',
    keywords: ['breach', 'disclosures', 'forums', 'watch', 'hibp'],
  },
  {
  ...
  },
  {
    ...
    description: 'Ransomware tracking - activity feed, map, ransomwhere, and negotiation reports.',
    sectionLabel: 'Threat Intel · Dark Web',
    group: 'threatintel',
  ...
  },
  {
    ...
    sectionLabel: 'Threat Intel · Supply Chain',
    group: 'threatintel',
    keywords: ['supply', 'chain', 'attacks', 'feed', 'ossf', 'malicious', 'packages'],
  },
  {
  ...
  },
  {
    ...
    label: 'F2T2EA',
    description: 'F2T2EA joint targeting cycle framework.',
    sectionLabel: 'Threat Intel · Knowledge',
    group: 'threatintel',
  },
  {
    ...
    label: 'OODA Loop',
    description: 'OODA decision cycle framework.',
    sectionLabel: 'Threat Intel · Knowledge',
    group: 'threatintel',
  },
  {
    ...
    label: 'Kill Chain v2',
    description: 'Cyber Kill Chain v2 - 7-phase chain plus lateral movement and campaign overlay.',
    sectionLabel: 'Threat Intel · Knowledge',
    group: 'threatintel',
  },
  {
    ...
    description: 'Unified Kill Chain - 18 phases across In / Through / Out cycles.',
    sectionLabel: 'Threat Intel · Knowledge',
    group: 'threatintel',
  },
  {
  ...
  },
  {
    ...
    label: 'CTI Bookmarks',
    description:
      'Curated open-source CTI links across Operational/Tactical/Strategic/Tools, tagged by platform integration status.',
    sectionLabel: 'Threat Intel · OSINT',
    group: 'threatintel',
    keywords: ['bookmarks', 'cti links', 'resources', 'reading list'],
  },
  {
  ...
  },
  {
    ...
    label: 'STIX Hub',
    description: 'STIX 2.1 bundle browsing, IP enrichment, and API access.',
    sectionLabel: 'Threat Intel · Tools',
    group: 'threatintel',
  ...
  },
  {
    ...
    description: 'Investigation management - active cases, watchlists, and workspaces.',
    sectionLabel: 'Threat Intel · Tools',
    group: 'threatintel',
