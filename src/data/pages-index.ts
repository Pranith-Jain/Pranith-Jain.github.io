...
const DFIR_PAGES: readonly PageEntry[] = [
  ...
  {
    path: '/cti',
    label: 'CTI Command Center',
    description: 'Cyber Threat Intelligence command center — live dashboards, actor tracking, and campaign monitoring.',
    sectionLabel: 'CTI · Overview',
    group: 'threatintel',
    keywords: ['cti', 'command', 'center', 'threat-intel', 'dashboard'],
  },
  {
    path: '/cti/iocs',
    label: 'CTI IOC Browser',
    description: 'Browse and search cyber threat intelligence indicators of compromise across all tracked campaigns.',
    sectionLabel: 'CTI · IOCs',
    group: 'threatintel',
    keywords: ['cti', 'ioc', 'indicator', 'compromise', 'browser'],
  },
  {
    path: '/cti/vulnerabilities',
    label: 'CTI Vulnerability Browser',
    description:
      'Browse and track vulnerabilities across the threat intelligence corpus — CVEs, KEV, and exploit status.',
    sectionLabel: 'CTI · Vulnerabilities',
    group: 'threatintel',
    keywords: ['cti', 'cve', 'vulnerability', 'kev', 'exploit'],
  },
  {
    path: '/cti/threats',
    label: 'CTI Threat Actor Directory',
    description: 'Directory of tracked threat actors with profiles, TTPs, campaigns, and attribution data.',
    sectionLabel: 'CTI · Actors',
    group: 'threatintel',
    keywords: ['cti', 'threat', 'actor', 'directory', 'profile'],
  },
  {
    path: '/cti/victims',
    label: 'CTI Victim Tracker',
    description: 'Track victims and target sectors across campaigns — sector distribution, victim counts, and trends.',
    sectionLabel: 'CTI · Victims',
    group: 'threatintel',
    keywords: ['cti', 'victim', 'target', 'sector', 'tracking'],
  },
  {
    path: '/cti/check',
    label: 'CTI Reputation Check',
    description: 'Quick reputation check for IPs, domains, hashes, and other indicators against threat intel feeds.',
    sectionLabel: 'CTI · Triage',
    group: 'threatintel',
    keywords: ['cti', 'reputation', 'check', 'lookup', 'enrichment'],
  },
  {
    path: '/cti/articles',
    label: 'CTI Intel Feed',
    description: 'Threat intelligence articles and research feed — curated reports, analysis, and briefings.',
    sectionLabel: 'CTI · Research',
    group: 'threatintel',
    keywords: ['cti', 'articles', 'feed', 'research', 'briefing'],
  },
  {
    path: '/cti/malware',
    label: 'CTI Malware Database',
    description: 'Malware family database with indicators, capabilities, and campaign associations.',
    sectionLabel: 'CTI · Malware',
    group: 'threatintel',
    keywords: ['cti', 'malware', 'family', 'database', 'ioc'],
  },
  {
    path: '/cti/campaigns',
    label: 'CTI Campaign Tracker',
    description: 'Track threat campaigns from initial access through monetization — timeline, IOCs, and TTPs.',
    sectionLabel: 'CTI · Campaigns',
    group: 'threatintel',
    keywords: ['cti', 'campaign', 'tracker', 'timeline', 'ttp'],
  },
  {
    path: '/cti/honeypot',
    label: 'CTI Honeypot Telemetry',
    description: 'Live honeypot telemetry — attack volume, top sources, exploit attempts, and payload analysis.',
    sectionLabel: 'CTI · Telemetry',
    group: 'threatintel',
    keywords: ['cti', 'honeypot', 'telemetry', 'attack', 'payload', 'exploit'],
  },
  {
    path: '/cti/reports',
    label: 'CTI Weekly Reports',
    description:
      'Weekly threat intelligence reports — curated analysis, trending threats, and forward-looking assessments.',
    sectionLabel: 'CTI · Reports',
    group: 'threatintel',
    keywords: ['cti', 'reports', 'weekly', 'analysis', 'assessment'],
  },
  {
    path: '/cti/geopolitics',
    label: 'CTI Geopolitics',
    description: 'Geopolitical threat landscape — nation-state activity, conflict zones, and cyber-kinetic risks.',
    sectionLabel: 'CTI · Geopolitics',
    group: 'threatintel',
    keywords: ['cti', 'geopolitics', 'nation-state', 'conflict', 'cyber-kinetic'],
  },
  {
    path: '/cti/markets',
    label: 'CTI Dark Web Markets',
    description: 'Dark web market monitoring — ransomware listings, exploit sales, and illicit service pricing.',
    sectionLabel: 'CTI · Dark Web',
    group: 'threatintel',
    keywords: ['cti', 'dark-web', 'market', 'ransomware', 'exploit', 'illicit'],
  },
  {
    path: '/cti/intelligence',
    label: 'CTI Correlation Graph',
    description: 'Cross-source intelligence correlation graph — connect actors, campaigns, IOCs, and infrastructure.',
    sectionLabel: 'CTI · Intelligence',
    group: 'threatintel',
    keywords: ['cti', 'correlation', 'graph', 'cross-source', 'intelligence'],
  },
  {
    path: '/cti/alerts',
    label: 'CTI Security Alerts',
    description: 'Real-time security alerts — breaking incidents, new CVEs, active campaigns, and urgent advisories.',
    sectionLabel: 'CTI · Alerts',
    group: 'threatintel',
    keywords: ['cti', 'alerts', 'security', 'breaking', 'urgent', 'advisory'],
  },
  {
    path: '/cti/ask',
    label: 'CTI Ask AI',
    description:
      'Ask questions about threat intelligence — AI-powered answers with cited sources and confidence scoring.',
    sectionLabel: 'CTI · AI',
    group: 'threatintel',
    keywords: ['cti', 'ask', 'ai', 'chat', 'question', 'threat-intel'],
  },
];
