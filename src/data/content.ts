export const personalInfo = {
  ...
  description: `a security analyst and detection engineer. I investigate phishing, BEC, and malware incidents for 150+ global brands, and ship the tools I use. There's a free DFIR toolkit on Cloudflare Workers (32 tools, 22 threat intel sources, no signup) at /dfir, including the Cyber Kill Chain, Diamond Model, OWASP Top 10, prompt-injection detection, an MCP / Claude Code auditor, a BEC spoofability score, a YARA/Sigma playground, and a curated LOLBins catalog. Currently expanding into AI security and NHI (Non-Human Identity) governance.`,
