export const personalInfo = {
  ...
  description: `a security analyst and detection engineer. I investigate phishing, BEC, and malware incidents for 150+ global brands, and ship the tools I use. There's a free DFIR toolkit on Cloudflare Workers (40 tools, 22 threat intel sources, no signup) at /dfir, including a Privacy & Data-Protection hub (GDPR · CCPA · DPDP · HIPAA · PCI DSS), a GRC hub (NIST CSF 2.0 · ISO 27001 · ISO 42001 · CIS · SOC 2 · SOC-CMM), a sensitive-data detector + classification templater, the OWASP NHI Top 10 + inventory, an AI agent attack-surface mapper, a PowerShell deobfuscator, a tabletop / IR-exercise generator, the Cyber Kill Chain, Diamond Model, OWASP Top 10 (Web/API/LLM), prompt-injection detection with red-team library, an MCP / Claude Code auditor, a BEC spoofability score, a YARA/Sigma playground, and a curated LOLBins catalog. Currently expanding into AI security, NHI (Non-Human Identity) governance, GRC, and DLP / data security.`,
