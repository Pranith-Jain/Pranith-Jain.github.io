 ...
 * Pranith Jain, CRUCIBLE (DFIR), and PANOPTICON (Threat Intel). The same
 * array is consumed twice:
...
export const HOME_FAQ: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      'Three parts. A profile with a brief, an experience timeline, a skills map, and case studies from real engagements. A free CRUCIBLE (DFIR & Security Toolkit) of 60-plus browser-side utilities for IOC checks, CVE triage, rule conversion, and email defense. And a live PANOPTICON (Threat Intelligence Platform) that pulls 90-plus intel sources and correlates IOCs in real time.',
  },
  {
  ...
  {
    question: 'How does PANOPTICON (Threat Intelligence Platform) work?',
    answer:
      'PANOPTICON aggregates 30-plus open and commercial feeds covering ransomware leak sites, threat-actor channels, CVE publications, dark-web mentions, and social-media signals. A daily job normalises entries, cross-correlates IOCs, and writes the result to a Cloudflare D1 database. The surface renders the latest activity as a 3D globe, a ransomware tracker, an actor knowledge base, and a daily briefing.',
  },
  {
