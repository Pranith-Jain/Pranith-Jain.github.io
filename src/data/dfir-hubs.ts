  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        tabId: 'rhysida-intrusion',
        label: 'Rhysida Intrusion Kit',
        desc: 'Rhysida ransomware intrusion analysis — TTPs, IOCs, detection rules, and mitigation guidance.',
        compVar: 'RhysidaIntrusion',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        path: '/dfir/fleet-map',
        tabId: 'fleet-map',
        label: 'Fleet Infrastructure Map',
        desc: 'Map and visualize infrastructure fleet — hosts, services, domains, and relationships.',
        compVar: 'FleetInfraMap',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        tabId: 'wordpress-sim',
        label: 'WordPress Vulnerability Simulator',
        desc: 'Simulate WordPress vulnerability scenarios — core, plugin, and theme CVE testing.',
        compVar: 'WordPressSim',
      },
    ],
  },
  {
