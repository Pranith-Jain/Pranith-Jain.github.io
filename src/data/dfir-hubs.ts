  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        tabId: 'chokepoints-framework',
        label: 'Chokepoint Framework',
        desc: '6-step identification process, maturity model, 4-question validation test.',
        compVar: 'DetectionChokepointsFramework',
        keywords: ['chokepoint', 'framework', 'maturity', 'detection-engineering'],
      },
      {
        path: '/dfir/chokepoints/cross-chain',
        tabId: 'cross-chain',
        label: 'Cross-Chain Ecosystem',
        desc: 'How attack chains feed into each other — infostealers fund ransomware, AiTM enables BEC.',
        compVar: 'CrossChainEcosystem',
        keywords: ['ecosystem', 'cross-chain', 'infostealer-ransomware', 'aitm-bec'],
      },
      {
        path: '/dfir/attack-chains/ransomware',
        tabId: 'chain-ransomware',
        label: 'Ransomware Chain',
        desc: 'BlackBasta, LockBit, Akira, Alphv, Play — TTP overlap matrix and actor convergence.',
        compVar: 'AttackChainRansomware',
        keywords: ['ransomware', 'lockbit', 'blackcat', 'akira', 'kill-chain'],
      },
      {
        path: '/dfir/attack-chains/infostealers',
        tabId: 'chain-infostealers',
        label: 'Infostealer Chain',
        desc: 'RedLine, LummaC2, Vidar, StealC, Raccoon — credential theft pipeline.',
        compVar: 'AttackChainInfostealers',
        keywords: ['infostealer', 'lumma', 'redline', 'credential-theft'],
      },
      {
        path: '/dfir/attack-chains/aitm',
        tabId: 'chain-aitm',
        label: 'AiTM / Phishing Chain',
        desc: 'Tycoon 2FA, Evilginx, EvilProxy — MFA bypass via session token theft.',
        compVar: 'AttackChainAitm',
        keywords: ['aitm', 'mfa-bypass', 'phishing', 'session-theft'],
      },
      {
        path: '/dfir/attack-chains/hypervisor',
        tabId: 'chain-hypervisor',
        label: 'Hypervisor Chain',
        desc: 'BRICKSTORM, UNC3886 targeting VMware vSphere. 393-day dwell time.',
        compVar: 'AttackChainHypervisor',
        keywords: ['hypervisor', 'vmware', 'esxi', 'vcenter'],
      },
      {
        path: '/dfir/attack-chains/identity',
        tabId: 'chain-identity',
        label: 'Identity Chain',
        desc: 'APT29, Storm-0501 exploiting Kerberos/LDAP/SAML/OAuth invariants.',
        compVar: 'AttackChainIdentity',
        keywords: ['identity', 'kerberos', 'dcsync', 'entra-id'],
      },
      {
        path: '/dfir/trends/clickfix',
        tabId: 'trend-clickfix',
        label: 'ClickFix Trend',
        desc: '25K+ sites, 9 variants. Cradle evolution, evasion acceleration.',
        compVar: 'TrendClickFix',
        keywords: ['clickfix', 'clipboard', 'social-engineering'],
      },
      {
        path: '/dfir/trends/edge-exploits',
        tabId: 'trend-edge',
        label: 'Edge Exploit Trends',
        desc: '15K attempts, 40+ CVEs. CitrixBleed 2, SAP, Cisco SD-WAN.',
        compVar: 'TrendEdgeExploits',
        keywords: ['edge-exploit', 'citrix', 'cve', 'honeypot'],
      },
      {
        path: '/dfir/trends/masq-infra',
        tabId: 'trend-masq',
        label: 'Masq Infrastructure',
        desc: 'Favicon-pivot discovery, JS-gated EXE, domain squatting.',
        compVar: 'TrendMasqInfra',
        keywords: ['masquerade', 'impersonation', 'brand-abuse'],
      },
      {
