...
export const TOOLS: Tool[] = [
  ...
  // ── TI Mindmap Hub MCP Tools (25 tools via mcp.ti-mindmap-hub.com) ──
  {
    ...
    pricing: 'free',
    description:
      'Search and list threat intelligence reports from ti-mindmap-hub.com. Filter by keyword, tags, source, or time range. Returns report metadata including actor, CVEs, IOCs, and TTP counts.',
  },
  {
  ...
  },
  {
    ...
    pricing: 'free',
    description:
      'Retrieve one of eight content slices for a report: summary, raw text, mindmap, TTPs table, TTPs execution, 5W context, STIX bundle, or IOCs.',
  },
  {
  ...
  },
  {
    ...
    pricing: 'free',
    description:
      'Search for an IOC (IP, hash, domain, URL) across all TI Mindmap Hub reports. Returns matching reports, first/last seen dates, and IOC type.',
  },
  {
    id: 'tim-search-cve',
    name: 'TIM: Search CVE',
  ...
  },
  {
    ...
    pricing: 'free',
    description:
      'Keyword search across the CVE database on TI Mindmap Hub. Returns matching CVEs with severity, CVSS, and exploitation flags.',
  },
  {
    id: 'tim-list-cves',
    name: 'TIM: List CVEs',
  ...
  },
  {
    ...
    pricing: 'free',
    description:
      'Submit a URL to TI Mindmap Hub for ingestion and analysis. Returns the article ID and processing status.',
  },
  {
