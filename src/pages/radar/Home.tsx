...
export default function RadarHome() {
  useDocumentMeta({
    ...
    description:
      'Free, browser-driven recon for any domain or URL: HTTP headers, redirect chains, server fingerprint, JavaScript inventory, exposed endpoints, security headers, and a 0-100 security score.',
    canonicalPath: '/radar',
  });
