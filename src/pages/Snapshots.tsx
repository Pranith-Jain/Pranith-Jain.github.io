...
export default function Snapshots(): JSX.Element {
  useDocumentMeta({
    ...
    description:
      'Live platform telemetry in one place — ransomware victims in the last 24h, top detections, IOC consensus, global pulse, latest briefing, feed health, and a featured tool.',
