...
export default function RegistryHive(): JSX.Element {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6 text-slate-900 dark:text-slate-100">
      ...
      {root && (
        <div className="mt-6 rounded-lg border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200))] shadow-e1 p-3 overflow-auto max-h-[70vh]">
          <Node k={root} depth={0} />
        </div>
      )}
    </div>
