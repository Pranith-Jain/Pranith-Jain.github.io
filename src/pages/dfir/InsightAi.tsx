          ...
          {result && !loading && (
            <>
              {selectedModes.size > 1 && (
                <div className="flex flex-wrap gap-1.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 shadow-e1 p-2">
                  {[...selectedModes].map((m) => {
              ...
              <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/40 shadow-e1 p-5">
                ...
                <div className="prose prose-sm dark:prose-invert max-w-none">
                  <pre className="bg-slate-50 dark:bg-slate-950 rounded-lg p-4 overflow-x-auto text-xs text-slate-700 dark:text-slate-300 font-mono border border-slate-200 dark:border-slate-800 whitespace-pre-wrap max-h-[600px] overflow-y-auto">
                    {result}
                  </pre>
                </div>
              </div>
