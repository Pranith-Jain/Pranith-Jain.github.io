        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {input.trim() && (
            <button
              ...
              className="text-meta font-mono px-2.5 py-1 rounded border border-slate-300 dark:border-slate-700 hover:border-brand-500/40 hover:text-brand-600 dark:hover:text-brand-400 inline-flex items-center gap-1"
            >
                  ...
                  >
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <pre className="text-meta font-mono text-slate-500 mt-2 whitespace-pre-wrap break-all bg-slate-50 dark:bg-slate-950 rounded p-2 border border-slate-200 dark:border-slate-800">
                          {f.evidence}
                        </pre>
