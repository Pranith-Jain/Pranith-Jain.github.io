  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 text-slate-900 dark:text-slate-100">
      ...
      <div className="animate-fade-in-up">
        <h1 className="text-3xl sm:text-4xl font-display font-bold mb-2">Linux IR Triage</h1>
        <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-2xl">
          Paste <span className="font-mono text-[13px]">auth.log</span> /{' '}
          <span className="font-mono text-[13px]">secure</span>, a crontab, or{' '}
          <span className="font-mono text-[13px]">~/.bash_history</span>. Heuristics surface SSH brute force,
                  ...
                  >
                    <div className="flex items-start gap-2.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <pre className="text-[12px] font-mono text-slate-500 mt-2 whitespace-pre-wrap break-all bg-slate-50 dark:bg-slate-950 rounded p-2 border border-slate-200 dark:border-slate-800">
                          {f.evidence}
                        </pre>
