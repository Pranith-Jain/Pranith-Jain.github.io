...
export default function ApiDocs(): JSX.Element {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 text-slate-900 dark:text-slate-100">
      ...
      <h1 className="text-3xl font-display font-bold flex items-center gap-3 mb-2"><Shield className="text-brand-600" /> API Documentation</h1>
      <p className="text-slate-600 dark:text-slate-400 mb-8">OpenAPI spec, API key management, webhook notifications, CLI tool</p>
