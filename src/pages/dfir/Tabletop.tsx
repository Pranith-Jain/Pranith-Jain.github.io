    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-12 text-slate-900 dark:text-slate-100">
      ...
      <div className="animate-fade-in-up">
        ...
        <p className="text-muted mb-2 leading-relaxed">
          ...
          <Link to="/threatintel/catalog?cat=actors" className="text-brand-600 dark:text-brand-400 hover:underline">
            the catalog
          </Link>
      ...
      <section className="surface-card p-4 mb-6">
        ...
        <div className="grid gap-1.5 sm:grid-cols-3 text-mini font-mono mb-3">
          ...
          <span>
            <span className="text-slate-500 dark:text-slate-400">Malware/TTP: </span>
      ...
      <section className="surface-card p-4">
        ...
        <p className="mt-3 text-xs font-mono text-slate-500 dark:text-slate-400 inline-flex items-center gap-1">
