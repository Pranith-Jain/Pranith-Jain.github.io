...
> = {
  techniques: {
    ...
    cardHover: 'hover:bg-orange-500/5 hover:shadow-e2',
    icon: 'T',
  },
  evasions: {
    label: 'Evasions',
    ...
    cardHover: 'hover:bg-purple-500/5 hover:shadow-e2',
    icon: 'E',
  },
  intents: {
    label: 'Intents',
    ...
    cardHover: 'hover:bg-red-500/5 hover:shadow-e2',
    icon: 'I',
  },
  inputs: {
    label: 'Inputs',
    ...
    cardHover: 'hover:bg-teal-500/5 hover:shadow-e2',
    icon: 'In',
  },
};
