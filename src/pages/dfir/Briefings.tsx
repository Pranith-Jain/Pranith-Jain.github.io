            ...
            >
              ...
              <div className="mt-2 flex items-center gap-1.5">
                <a
                  ...
                  className="inline-flex items-center gap-1 rounded border border-slate-200 dark:border-slate-700 px-2 py-0.5 text-micro text-slate-500 hover:text-brand-600 dark:hover:text-brand-400 hover:border-brand-500/40 transition-colors"
                  title="Share on X"
                >
