          ...
          <div className="rounded-lg border border-slate-200 dark:border-slate-800 overflow-auto">
            <table className="w-full text-[11px] font-mono">
              ...
              <tbody>
                {pe.sections.map((s, i) => (
                  <tr key={i}>
                    <td className="px-2 py-1 border-b border-slate-100 dark:border-slate-800">{s.name}</td>
                    <td className="px-2 py-1 border-b border-slate-100 dark:border-slate-800">{s.vsize}</td>
                    <td className="px-2 py-1 border-b border-slate-100 dark:border-slate-800">{s.rsize}</td>
                    <td
                      className={`px-2 py-1 border-b border-slate-100 dark:border-slate-800 ${s.entropy >= 7.2 ? 'text-rose-600 dark:text-rose-400 font-bold' : ''}`}
                    >
                      {s.entropy}
                      {s.entropy >= 7.2 ? ' ⚠packed?' : ''}
                    </td>
                    <td className="px-2 py-1 border-b border-slate-100 dark:border-slate-800">{s.flags}</td>
                  </tr>
                ))}
              </tbody>
            </table>
