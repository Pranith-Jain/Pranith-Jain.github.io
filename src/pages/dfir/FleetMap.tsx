...
const SIM_URL = 'https://mr-r3b00t.github.io/org_cyber_attack_sim/fleet.html';

export default function FleetMap(): JSX.Element {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-12 text-slate-900 dark:text-slate-100">
      ...
      <div className="animate-fade-in-up">
        <h1 className="text-3xl sm:text-4xl font-display font-semibold mb-2 flex items-center gap-3">
          <Map size={28} className="text-brand-600 dark:text-brand-400" /> UK Threat Map — Fleet Simulation
        </h1>
        <p className="text-muted mb-2 leading-relaxed">
          National-scale attack surface simulation: 300 organisations across the UK, modelling SSL-VPN, Citrix, VMware
          Horizon, RDP, WordPress, and management interface exposure from 2018–2025.
        </p>
        <p className="text-xs text-slate-500 dark:text-slate-400 font-mono mb-6">
          ...
          · Fleet-scale scenario, fully client-side, MITRE ATT&CK tagged.
        </p>
      </div>
      ...
      <div className="grid gap-3 sm:grid-cols-3 mb-6">
        {[
          { label: '300 orgs', desc: 'National attack surface model' },
          { label: '2018–2025', desc: '7-year simulation window' },
          { label: '6 exposure types', desc: 'SSL-VPN, Citrix, Horizon, RDP, WP, Mgmt' },
        ].map((f) => (
          <div key={f.label} className="surface-card p-3 shadow-e1">
      ...
      {/* Embedded simulation */}
      <div className="surface-card shadow-e2 overflow-hidden">
