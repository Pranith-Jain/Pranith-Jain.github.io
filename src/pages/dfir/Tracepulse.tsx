                ...
                <div className="flex items-start justify-between gap-3 flex-wrap">
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="text-xs font-mono px-2 py-1 rounded border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:border-brand-500/30 transition-colors"
                    >
                  ...
                  {pack.queries.map((q, i) => (
                    <div key={i}>
                      ...
                      {expandedQuery === `${pack.id}-${i}` && (
                        <pre className="bg-slate-50 dark:bg-slate-950 px-5 py-4 overflow-x-auto text-xs text-slate-700 dark:text-slate-300 font-mono border-t border-slate-100 dark:border-slate-800 whitespace-pre-wrap">
                          {q.code}
                        </pre>
                      )}
                    </div>
