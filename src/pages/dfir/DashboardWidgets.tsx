...
export default function DashboardWidgets(): JSX.Element {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 text-slate-900 dark:text-slate-100">
      ...
      <h1 className="text-3xl font-display font-bold flex items-center gap-3 mb-2"><Shield className="text-brand-600" /> Dashboard Widgets</h1>
      <p className="text-slate-600 dark:text-slate-400 mb-8">Real-time IOC ticker, geopolitical heatmap, threat actor spotlight, collection coverage matrix</p>
