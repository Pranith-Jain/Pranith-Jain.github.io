...
export default function ToolsCategory(): JSX.Element {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-8 py-6 text-slate-900 dark:text-slate-100">
          ...
          <Link
            ...
            className={`px-3 py-1.5 rounded border ${
              v === g
                ...
                : 'border-slate-200 dark:border-[#1e2030] text-slate-500 hover:border-brand-500/40'
            }`}
          >
            {GROUP_META[v].label}
          </Link>
        ...
        <section key={s.id} className="mb-10">
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {s.tools.map((t) => {
              const Icon = t.icon;
              const card = (
                <div className="group h-full flex flex-col rounded-lg border border-slate-200 dark:border-[#1e2030] bg-white dark:bg-[#12121a] shadow-e1 p-5 hover:border-brand-500/40 transition-colors">
        ...
        <section className="mt-12 mb-8 rounded-lg border border-brand-500/30 dark:border-brand-500/20 bg-brand-500/5 p-8">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {[
              ...
              <div
                key={ex.platform}
                className="rounded-lg border border-slate-200 dark:border-[#1e2030] bg-white dark:bg-[#12121a]/60 shadow-e1 p-3 flex items-center gap-3"
              >
      ...
      <section className="mt-12 rounded-lg border border-slate-200 dark:border-[#1e2030] bg-white dark:bg-[#12121a] p-8">
