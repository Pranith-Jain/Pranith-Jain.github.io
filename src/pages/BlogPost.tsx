          ...
          <>
            ...
            <div className="mt-8 flex items-center gap-3 pt-6 border-t border-slate-200 dark:border-[rgb(var(--border-400))]">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-md border border-slate-200 dark:border-[rgb(var(--border-400))] px-3 py-1.5 text-xs font-semibold text-muted hover:bg-slate-50 dark:hover:bg-[rgb(var(--surface-300))] hover:border-brand-300 dark:hover:border-brand-700 transition-colors"
              >
            ...
            <section className="mt-6 surface-card p-6 sm:p-8">
              <div className="sm:flex sm:items-center sm:justify-between gap-6">
                ...
                <div className="flex flex-wrap gap-2 shrink-0">
                  ...
                  <Link
                    to="/threatintel"
                    className="inline-flex items-center gap-1.5 rounded-md border border-slate-300 dark:border-[rgb(var(--border-400))] px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-300 transition hover:bg-slate-50 dark:hover:bg-[rgb(var(--surface-300))]"
                  >
                    Threat Intel
                  </Link>
                </div>
