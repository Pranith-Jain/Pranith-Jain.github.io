            ...
            <div className="space-y-4">
              <div className="rounded-xl bg-white dark:bg-[rgb(var(--surface-200))] border border-slate-200 dark:border-[rgb(var(--border-400))] p-5">
                ...
                {result.a && result.a.length > 0 && (
                  <div className="mb-3">
                    <label className="text-micro font-mono uppercase text-slate-500 dark:text-slate-400">A Records</label>
                ...
                {result.ns && result.ns.length > 0 && (
                  <div className="mb-3">
                    <label className="text-micro font-mono uppercase text-slate-500 dark:text-slate-400">NS Records</label>
                ...
                {result.mx && result.mx.length > 0 && (
                  <div className="mb-3">
                    <label className="text-micro font-mono uppercase text-slate-500 dark:text-slate-400">MX Records</label>
                    <div className="space-y-1 mt-1">
                      {result.mx.map((mx) => (
                ...
                {result.txt && result.txt.length > 0 && (
                  <div>
                    <label className="text-micro font-mono uppercase text-slate-500 dark:text-slate-400">TXT Records</label>
                    <div className="space-y-1 mt-1">
                      {result.txt.map((t, i) => (
