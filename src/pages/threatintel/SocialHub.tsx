...
const TechAiNews = lazy(() => import('./TechAiNews'));
...
export default function SocialHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<MessageCircle size={28} />} title="Social Media OSINT" description="Real-time social media firehoses and tech news aggregation.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Social tools">
