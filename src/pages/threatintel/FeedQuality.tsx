        ...
        {data && (
          <>
            ...
            <section aria-label="Feed quality scorecard" className="space-y-2.5">
              ...
              {filtered.length === 0 && (
                <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-e1 p-6 text-center text-sm text-slate-500 font-mono">
...
function FeedRow({
  ...
  return (
    <article className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-e1 overflow-hidden">
      ...
      {expanded && (
        <div className="px-4 pb-4 pt-1 border-t border-slate-200 dark:border-slate-800 space-y-3 bg-slate-50/40 dark:bg-slate-950/40">
          {PILLAR_KEYS.map((k) => {
            const p = feed[k];
