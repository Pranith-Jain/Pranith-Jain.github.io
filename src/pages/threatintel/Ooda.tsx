    ...
    >
      ...
      <section className="mb-12">
        <header className="flex items-end justify-between mb-4">
          <h2 className="text-xl font-display font-semibold text-heading">The OODA loop</h2>
      ...
      <section className="mb-12">
        <header className="mb-4">
          <h2 className="text-xl font-display font-semibold text-heading">Walk an incident through OODA</h2>
      ...
      <section>
        ...
        <ul className="space-y-1.5 text-xs text-muted">
          <li>
            <strong className="text-heading">John Boyd, "A Discourse on Winning and Losing"</strong> &mdash; the 1987
            briefing that formalized the OODA loop.
          </li>
          <li>
          ...
          <li>
            <strong className="text-heading">"Getting Inside the Enemy's OODA Loop" (Boyd, 1987)</strong> &mdash; the
            tempo argument: act faster than the adversary can react.
          </li>
          <li>
            <strong className="text-heading">
          ...
          <li>
            <strong className="text-heading">SANS FOR578 &mdash; Cyber Threat Intelligence</strong> &mdash; treats
            decision cycles (OODA) as the tempo layer under the CTI workflow.
          </li>
          <li>
            <strong className="text-heading">
