...
function DNACard({ title, items, color }: { title: string; items: string[]; color: string }) {
  ...
  // 10-colour rainbow (red/orange/yellow/.../teal) was arbitrary, off-palette,
  // and a generic-AI tell — collapsed to one neutral on-brand surface. The
  // `color` prop is retained for call-site compatibility but no longer themes.
