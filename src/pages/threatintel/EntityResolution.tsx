...
export default function EntityResolution(): JSX.Element {
  ...
  return (
    ...
    >
      {/* Mode toggle */}
      <div className="flex gap-1 mb-6 p-0.5 rounded-lg bg-slate-100 dark:bg-[rgb(var(--surface-300))] w-fit">
        <button
          type="button"
              ...
              <div className="grid gap-2">
                {extracted.map((e) => {
                  ...
                  return (
                    <div
                      key={e.id}
                      className="rounded-lg border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200))] shadow-e1 p-3 flex items-center justify-between"
                    >
