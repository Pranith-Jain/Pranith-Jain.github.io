...
export default function EntityResolution(): JSX.Element {
  ...
  return (
    <DataPageLayout
      ...
      description="Resolve threat actor names, ransomware groups, CVEs, IPs, domains, and hashes against a 500+ entry alias index with heuristic NVD/KEV actor scanning."
    ...
    >
      ...
      {mode === 'resolve' ? (
        <>
          <form onSubmit={handleSubmit} className="mb-8">
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-1.5 top-1/2 -translate-y-1/2 rounded px-3 py-1 text-mini font-mono font-medium bg-brand-600 text-white hover:bg-brand-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
          ...
          {error && (
            <div className="mb-6 rounded-xl border border-rose-200 dark:border-rose-900 bg-rose-50 dark:bg-rose-950 p-4 text-sm text-rose-700 dark:text-rose-300 font-mono">
              {error}
            </div>
          )}
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-end mt-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded px-4 py-1.5 text-mini font-mono font-medium bg-brand-600 text-white hover:bg-brand-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
