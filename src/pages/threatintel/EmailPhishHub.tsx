...
const PhishingUrls = lazy(() => import('./PhishingUrls'));
const ScamWatch = lazy(() => import('./ScamWatch'));
...
export default function EmailPhishHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<Mail size={28} />} title="Email & Phishing Intelligence" description="Phishing feeds, URL tracking, and scam monitoring.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Email tools">
