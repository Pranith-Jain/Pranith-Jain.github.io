      ...
      <div className="animate-fade-in-up mb-8 flex items-start justify-between">
        <div>
          <h1 className="text-3xl sm:text-4xl font-display font-bold flex items-center gap-3">
            <FileText size={28} className="text-rose-600 dark:text-rose-400" /> Intelligence Assessments
          </h1>
        ...
        <div className="space-y-2">
          {data.map((a) => (
            <Link
              ...
              className="block surface-card/40 shadow-e1 p-4 hover:border-rose-500/40 transition-colors"
            >
