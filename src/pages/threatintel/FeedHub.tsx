...
const ThreatFeeds = lazy(() => import('./ThreatFeeds'));
...
export default function FeedHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<Radio size={28} />} title="Feed & Source Management" description="Feed catalogs, source health, quality metrics, and scheduling.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Feed tools">
