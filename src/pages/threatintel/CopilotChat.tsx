...
export default function CopilotChat(): JSX.Element {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12 text-slate-900 dark:text-slate-100">
      ...
      <div className="rounded-lg border border-slate-200 dark:border-[rgb(var(--border-400))] bg-white dark:bg-[rgb(var(--surface-200))] shadow-e1 mb-4 min-h-[400px] flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {['CVE-2024-1709', 'LockBit', 'Scattered Spider', '8.8.8.8'].map((ex) => (
                  <button
                    ...
                    className="text-xs font-mono px-2.5 py-1 rounded-full border border-slate-200 dark:border-[rgb(var(--border-400))] hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                  >
                    {ex}
                  </button>
                ))}
            ...
            <div className="flex justify-start">
              <div className="max-w-[90%] rounded-lg px-4 py-3 bg-slate-100 dark:bg-slate-800 space-y-3">
                ...
                {agentSteps.map((step) => (
                  <div
                    key={step.stepNumber}
                    className="border border-slate-200 dark:border-[rgb(var(--border-400))] rounded-lg overflow-hidden text-xs"
                  >
                    ...
                    <details className="px-3 py-2">
                      ...
                      <div className="mt-2 space-y-2">
                        ...
                        {step.observation && (
                          <p className="text-slate-500 italic border-t border-slate-200 dark:border-[rgb(var(--border-400))] pt-1.5 mt-1.5">
                            {step.observation}
                          </p>
                        )}
                      </div>
        ...
        <div className="border-t border-slate-200 dark:border-[rgb(var(--border-400))] p-4">
          <div className="relative">
            <input
              ...
              disabled={loading}
              className="w-full pr-14 py-2.5 pl-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-[rgb(var(--border-400))] rounded-lg font-mono text-sm focus:outline-none focus:border-brand-500 dark:focus:border-brand-400 disabled:opacity-50"
            />
            <button
