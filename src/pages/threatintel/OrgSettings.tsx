          ...
          <div className="surface-card p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="inline-flex items-center gap-1 text-xs font-mono px-2 py-1 rounded bg-rose-500/10 text-rose-600 dark:text-rose-400 hover:bg-rose-500/20"
              >
                <Plus size={12} /> New
              </button>
            </div>
            ...
            {showCreate && (
              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    type="submit"
                    className="flex-1 px-3 py-1.5 text-xs rounded bg-rose-600 text-white hover:bg-rose-700"
                  >
                    Create
                  </button>
                  <button
            ...
            {orgs.length === 0 ? (
              <div className="text-xs text-slate-500 dark:text-slate-400 text-center py-4">No organizations yet</div>
            ) : (
              <div className="space-y-1">
                {orgs.map((org) => (
                  ...
                  >
                    ...
                    {org.description && (
                      <div className="text-slate-500 dark:text-slate-400 mt-0.5 line-clamp-1">{org.description}</div>
                    )}
                  </button>
                ))}
              </div>
          ...
          {selectedOrg ? (
            <div className="surface-card p-4">
              ...
              <form onSubmit={inviteMember} className="flex gap-2 mb-4">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center gap-1 px-3 py-1.5 text-xs rounded bg-rose-600 text-white hover:bg-rose-700"
                >
                  <Mail size={12} /> Invite
                </button>
              </form>
            ...
            <div className="surface-card p-8 text-center text-slate-500 dark:text-slate-400 text-sm">
