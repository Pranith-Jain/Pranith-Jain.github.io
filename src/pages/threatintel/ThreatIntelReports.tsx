  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs font-mono text-slate-500">{filtered.length} reports</span>
      </div>
        ...
        <div className="px-4 pb-4 border-t border-slate-100 dark:border-slate-800">
          ...
          {report.iocs && report.iocs.length > 0 && (
            <div className="mb-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-950 rounded-lg p-3 font-mono text-xs space-y-1">
