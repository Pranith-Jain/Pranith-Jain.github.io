...
const CveResourcesCatalog = lazy(() => import('./CveResourcesCatalog'));
...
export default function VulnHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<Bug size={28} />} title="Vulnerability Intelligence" description="CVE feeds, advisories, and vulnerability resource catalogs.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Vulnerability tools">
