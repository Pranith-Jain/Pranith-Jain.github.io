...
const YaraPage = lazy(() => import('./Yara'));
...
export default function DetectionHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<ShieldCheck size={28} />} title="Detection & Rules" description="Detection rules, DISARM framework, YARA, and threat mapping.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Detection tools">
