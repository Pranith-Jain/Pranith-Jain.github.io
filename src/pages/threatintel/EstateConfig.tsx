              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-muted font-mono">{a.value}</div>
                  </div>
                  <button
                    type="button"
                    onClick={() => deleteAsset(a.id)}
                    className="p-1.5 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 text-muted hover:text-red-500"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
