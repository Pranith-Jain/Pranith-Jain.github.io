...
export default function TelegramDiscoveredChannels(): JSX.Element {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-8 py-12 text-slate-900 dark:text-slate-100">
      ...
      {showToken && (
        <div className="animate-fade-in-up mb-6 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-e1 p-3.5">
        ...
        {filtered.length === 0 ? (
          ...
          <div className="space-y-2">
            {filtered.map((ch) => (
              <div
                key={ch.id}
                className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-e1 p-3.5 flex items-center justify-between gap-4"
              >
