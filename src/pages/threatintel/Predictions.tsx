...
function MarketCard({ m }: { m: PredictionMarket }): JSX.Element {
  ...
  return (
    <a
      ...
      className="group block rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 p-5 hover:border-brand-300 dark:hover:border-brand-700 transition-colors"
    >
