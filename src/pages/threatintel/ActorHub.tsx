...
const ActorDirectory = lazy(() => import('../dfir/ActorDirectory'));
...
export default function ActorHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<Users size={28} />} title="Threat Actor Intelligence" description="Unified actor browser — directory, DNA, timeline, attribution, and username search.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Actor tools">
