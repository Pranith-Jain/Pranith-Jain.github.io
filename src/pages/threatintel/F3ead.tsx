    ...
    >
      ...
      <section className="mb-12">
        <header className="flex items-end justify-between mb-4">
          <h2 className="text-xl font-display font-semibold text-heading">The F3EAD loop</h2>
          <p className="text-xs font-mono text-muted hidden sm:block">ops &rarr; intel &rarr; feedback to ops</p>
        </header>
      ...
      <section className="mb-12">
        <header className="mb-4">
          <h2 className="text-xl font-display font-semibold text-heading">Walk an incident through F3EAD</h2>
      ...
      <section>
        ...
        <ul className="space-y-1.5 text-xs text-muted">
          <li>
            ...
            origin of the F2T2EA / F3EAD targeting cycle. See the{' '}
          ...
          <li>
            <strong className="text-heading">JP 3-05.1 (Joint Special Operations)</strong> &mdash; joint doctrine for
            the targeting pipeline F3EAD is derived from.
          </li>
          <li>
            <strong className="text-heading">SANS FOR578 &mdash; Cyber Threat Intelligence</strong> &mdash; the
            canonical CTI adaptation of F3EAD taught in industry training.
          </li>
          <li>
            <strong className="text-heading">CREST (UK) &mdash; Cyber Threat Intelligence maturity guidance</strong>{' '}
