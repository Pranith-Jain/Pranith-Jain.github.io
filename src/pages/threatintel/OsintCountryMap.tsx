        ...
        <div className="flex gap-4 flex-col lg:flex-row">
          ...
          <div className="lg:w-3/5 w-full">
            <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 overflow-hidden">
              ...
              <Suspense fallback={<div className="h-[400px] flex items-center justify-center text-slate-500 text-sm">Loading map...</div>}>
                <OsintMapChart
                  topoUrl={TOPO_URL}
              ...
              <div className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/60 flex flex-col h-[500px]">
                ...
                <div className="p-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between shrink-0">
                  <div>
                    ...
                    <p className="text-xs text-slate-500">{selectedResources.length} of {selectedCountry.resources.length} resources</p>
                  </div>
                  <button
...
function ResourceRow({ resource }: { resource: OsintCountryResource }): JSX.Element {
  ...
  return (
    <div className="px-3 py-2 hover:bg-slate-100 dark:hover:bg-slate-800/50 transition-colors group">
