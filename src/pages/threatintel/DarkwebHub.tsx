...
const DarkWeb = lazy(() => import('./DarkWeb'));
...
export default function DarkwebHub(): JSX.Element {
  ...
  return (
    <DataPageLayout backTo="/threatintel" icon={<Eye size={28} />} title="Dark Web Intelligence" description="Dark web monitoring, forums, markets, and underground activity.">
      <nav className="flex flex-wrap gap-1 border-b border-slate-200 dark:border-slate-800 mb-6" aria-label="Dark web tools">
