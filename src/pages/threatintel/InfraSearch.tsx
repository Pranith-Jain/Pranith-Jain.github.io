        ...
        <form onSubmit={(e) => onSubmit(e)} className="flex gap-2">
          <div className="relative flex-1 min-w-[220px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 font-mono text-sm text-slate-900 dark:text-slate-100 focus:border-brand-500/60 focus:outline-none"
              autoComplete="off"
              spellCheck={false}
          ...
          <div className="mt-3 flex flex-wrap gap-1.5">
            ...
            {QUICK_SEARCHES.map((qs) => (
              <button
                ...
                className="text-xs font-mono px-2 py-0.5 rounded border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-200 transition"
              >
                {qs.icon} {qs.label}
              </button>
            ))}
              ...
              <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                ...
                <div className="max-h-[480px] overflow-y-auto">
                  {filtered.slice(0, 200).map((r) => (
                    <div
                      key={r.id}
                      className="flex items-center gap-2.5 px-4 py-2 border-b border-slate-100 dark:border-slate-800/50 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition text-sm cursor-default"
                    >
                      <span
