...
const PRERENDERED_ROUTES = new Map<string, string>([
  ...
  ['/threatintel/f2t2ea', '/__prerendered/threatintel__f2t2ea'],
  ['/threatintel/ooda', '/__prerendered/threatintel__ooda'],
  ['/threatintel/kill-chain-v2', '/__prerendered/threatintel__kill-chain-v2'],
  ['/threatintel/unified-kill-chain', '/__prerendered/threatintel__unified-kill-chain'],
