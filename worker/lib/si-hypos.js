 ...
 */
import { loadSiIndex, getSiSkill } from './si-manifest';
// ---------------------------------------------------------------------------
...
function environmentBias(env, h) {
  if (!env) return 0;
...
function scoreHypothesis(h, obs) {
...
// Public entry point.
// ---------------------------------------------------------------------------
export async function siHyposGenerate(obs, env = {}) {
