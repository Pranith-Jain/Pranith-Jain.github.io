...
// ---------------------------------------------------------------------------
function parseReceived(value, raw, idx, prevDate) {
...
function splitAuthMethods(value) {
...
function buildFlags(headers, auth, hops) {
  const flags = [];
...
// Public entry point.
// ---------------------------------------------------------------------------
export function siParseEmailHeaders(input, opts = {}) {
