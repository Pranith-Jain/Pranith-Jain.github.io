...
export function FileUpload({
  ...
  return (
    <div>
      ...
      {state.status === 'uploading' && <div style={{ width: `${state.progress}%`, height: 4, background: '#000' }} />}
      {state.status === 'success' && state.url && <img src={state.url} alt="uploaded" style={{ maxWidth: 200 }} />}
