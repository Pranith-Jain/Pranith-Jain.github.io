...
**Button Labels (15%)** — every button must finish the sentence "I want to \_\_\_." "Submit" fails this test. "Save draft", "Send invite", "Create project" pass it.
...
Every button finishes the sentence "I want to \_\_\_."
